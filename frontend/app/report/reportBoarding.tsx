...
import icon from "@/assets/images/report/icon.png";

const boardingData = {
    image: icon,
    name: "Lapor Cepat",
    desc: "Memberi kemudahan dalam melaporkan situasi darurat secara cepat dan tetap menjaga kerahasiaan identitas Anda.",
    route: "/report" as any
}
