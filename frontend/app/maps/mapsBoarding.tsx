...
import icon from "@/assets/images/maps/icon.png";

const boardingData = {
    image: icon,
    name: "Pantau Sekitar",
    desc: "Pantau Sekitar memungkinkan pengguna memantau kondisi lingkungan sekitar secara real-time untuk meningkatkan kewaspadaan.",
    route: "/maps" as any
}

export default function MapsBoarding() {
