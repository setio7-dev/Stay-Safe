...
const boardingData = {
    image: icon,
    name: "Darurat",
    desc: "memberi bantuan cepat saat kamu merasa terancam, dengan sekali tekan menghubungi kontak atau layanan darurat terdekat.",
    route: "/warning" as any
}

export default function WarningBoarding() {
