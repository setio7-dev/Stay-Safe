...
const API = axios.create({
    ...
    baseURL: "http://10.203.1.82:8000/api",
...
export const StorageAPI = "http://10.203.1.82:8000/storage";
...
export const moodDetectionAPI = "http://10.203.1.82:6100/predict";
...
export const factDetectionAPI = "http://10.203.1.82:6200/api/predict";