...
import icon from "@/assets/images/meditation/icon.png";

const boardingData = {
    image: icon,
    name: "Meditasi",
    desc: "Fitur Meditasi membantu menenangkan pikiran dan meredakan stres agar Anda lebih rileks dan seimbang.",
    route: "/meditation" as any
}

export default function MeditationBoarding() {
