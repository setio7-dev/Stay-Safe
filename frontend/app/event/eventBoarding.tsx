...
import icon from "@/assets/images/event/icon.png";

const boardingData = {
    image: icon,
    name: "Webinar",
    desc: "Webinar memberikan ruang belajar interaktif bersama narasumber ahli, menghadirkan wawasan baru dan solusi praktis.",
    route: "/event" as any
}

export default function EventBoarding() {
