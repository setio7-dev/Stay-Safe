...
import icon from "@/assets/images/consultation/icon.png";

const boardingData = {
    image: icon,
    name: "Konsultasi",
    desc: "Layanan Konsultasi membantu kamu terhubung dengan tenaga profesional untuk mendapatkan dukungan, saran, dan pendampingan sesuai kebutuhan.",
    route: "/consultation" as any
}

export default function ConsultationBoarding() {
